...
class SecuritySettings(BaseModel):
    # Dev keys are generated by `make keys` (scripts/generate_dev_keys.py) into
    # secrets/, which is gitignored — never committed, never defaulted to a real key.
    ...
    failed_login_lockout_seconds: int = 300
    register_throttle_per_hour: int = 10
